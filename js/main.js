...
import { PhysicsEngine } from './physics.js?v=15';
import { InputHandler } from './input.js?v=15';
import { UIHandler } from './ui.js?v=15';
...
class Simulator {
    ...
    animate() {
        ...
        if (this.state === 'PLAYING') {
            ...
            this.audio.update(axes, armed, this.physics.droneBody.velocity.length());
